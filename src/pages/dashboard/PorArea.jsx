...
export default function PorArea({ projeto, areasCalc, todosControles, loading, navigate, loadDados }) {
  ...
  function getModalActions(c) {
    ...
    if (podeEditarEste && st === 'teste_pendente') return { primary: { label: '📄 Baixar Ficha', color: 'var(--copper-text)', bg: 'rgba(204,145,94,0.12)', border: 'rgba(204,145,94,0.45)', onClick: () => { setAtualizarFicha(true); setAtualizarRow(c); setModalRow(null) } } }
